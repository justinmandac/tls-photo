<%-- 
    ...
    Created on : 11 28, 12, 12:37:31 AM
    Author     : Bien Mandac
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="controllers.AssignmentOps,models.Assignment" %>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <%
            ...
            boolean stat = AssignmentOps.AddAssignment(a);
            if(stat) {%>
            <h2>Success!</h2>
            <p><%= request.getParameter("title")%> has been added.</p>
               <%}
            else
            {%>
                    <h2>Ooops D:</h2>
                    <p>An error has occurred. Consider getting yourself a 
                    nice, hot cup of coffee while we try to fix this.
                    </p>
            <%}                 
